...
@interface YKBirthdayEnvelopeView () <CAAnimationDelegate>
...
@implementation YKBirthdayEnvelopeView
...
- (void)setupSubviews {
    ...
    [self.clickButton setTitleColor:[UIColor yk_colorWithValue:0xff74000d] forState:UIControlStateNormal];
    [self.clickButton setTitleColor:[UIColor yk_colorWithValue:0xff74000d] forState:UIControlStateHighlighted];
...
- (void)setBirthdayModel:(YKBirthdayModel *)birthdayModel {
    _birthdayModel = birthdayModel;
    NSString *buttonTitle = self.birthdayModel.birthdayLayerType == YKBirthdayLayerTypeForA ? @"开启惊喜" : @"快去送祝福";
    [self.clickButton setTitle:buttonTitle forState:UIControlStateNormal];
    YKBirthdayUserDescView *descView = [[YKBirthdayUserDescView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.letterPaperImageView.frame) *self.uiScale, CGRectGetHeight(self.letterPaperImageView.frame) *self.uiScale) birthdayModel:self.birthdayModel];
...
- (void)startLidFirtAnimation {
    ...
    [animation setValue:@(YKBirthdayAnimationTypeLidAnimationFirst) forKey:KYKBirthdayAnimationType];
...
- (void)startLidSecondAnimation {
    ...
    animation.toValue  = [NSValue valueWithCATransform3D:transForm3D];
    [animation setValue:@(YKBirthdayAnimationTypeLidAnimationSecond) forKey: KYKBirthdayAnimationType];
    [self.lidImageView.layer addAnimation:animation forKey:nil];
}
...
- (void)startLetterPaperAnimation {
    ...
    [moveAnimation setValue:@(YKBirthdayAnimationTypeLetterPaperAnimation) forKey:KYKBirthdayAnimationType];
...
- (void)showButtonAnimation {
    ...
    [opacityAnimation setValue:@(YKBirthdayAnimationTypeShowButton) forKey:KYKBirthdayAnimationType];
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag {
    ...
    switch (value) {
        case YKBirthdayAnimationTypeLidAnimationFirst:
            [self startLidSecondAnimation];
            break;
        case YKBirthdayAnimationTypeLidAnimationSecond:
            ...
            break;
        case YKBirthdayAnimationTypeLetterPaperAnimation:
            [self showButtonAnimation];
            break;
        case YKBirthdayAnimationTypeShowButton:
